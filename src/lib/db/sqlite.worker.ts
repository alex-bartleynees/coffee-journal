  ...
  database.exec({
    sql: `
		...
		CREATE TABLE brews_v8 (
			...
			descriptors TEXT DEFAULT '[]', with_milk INTEGER, milk_drink TEXT, espresso_drink TEXT,
		...
		INSERT INTO brews_v8 (
			...
			flavor, body, finish, descriptors, with_milk, milk_drink, espresso_drink, cuts_thru_milk,
...
async function initialize(): Promise<void> {
  ...
  try {
    ...
    console.warn(
      "[sqlite] OPFS persistence unavailable, using in-memory DB:",
      e,
    );
